    ...
    constructor() {
        ...
        this.oracoes.push(
            ...
            },
            {
                ...
                oracaoLatim: "Veni, Creator Spíritus,<br> mentes tuórum visita, <br> imple supérna grátia, <br>  quae tu creásti péctora. <br> Qui díceris Paráclitus, <br> altíssimi donum Dei, <br> fons vivus, ignis, cáritas, <br> et spiritális únctio. <br> Tu septifórmis múnere, <br> dígitus paternae déxterae, <br>  tu rite promíssum Patris, <br> sermóne ditans gúttura. <br> Accénde lumen sénsibus; <br> infunde amórem córdibus, <br> infírma nostri córporis <br> virtúte firmans pérpeti. <br> Hostem repéllas lóngius, <br> pacémque dones prótinus; <br> ductóre sic te praevio <br> vitemus omne noxium. <br> Per te sciámus da Patrem, <br> noscamus atque Filium; <br> teque utriúsque Spíritum <br> credamus omni témpore. <br> Deo Patri sit glória, <br> et Fillio, qui a mórtuis <br> surréxit, ac Paráclito, <br> in saeculórum saecula. <br><br> Amen <br>"
            },
        )
